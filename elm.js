...
var _Browser_decodeEvent = F2(function(decoder, event)
{
	...
	return elm_lang$core$Result$isOk(result)
		...
		: elm_lang$core$Maybe$Nothing
});var author$project$App$Model$Dress = F6(
	function (id, name, description, images, variants, visible) {
		return {description: description, id: id, images: images, name: name, variants: variants, visible: visible};
	});
var author$project$App$Model$Inventory = F2(
	function (version, dresses) {
		return {dresses: dresses, version: version};
	});
var author$project$App$Model$Variant = F3(
	function (color, price, size) {
...
var author$project$App$Init$initial_state = A2(
	author$project$App$Model$Inventory,
	1,
	_List_fromArray(
		[
			A6(
			author$project$App$Model$Dress,
			1,
			'Lauren',
			elm_lang$core$Maybe$Nothing,
			elm_lang$core$Maybe$Nothing,
			_List_fromArray(
				[
					A3(author$project$App$Model$Variant, 'royal blue', '$750', '6'),
					A3(author$project$App$Model$Variant, 'royal blue', '$750', '10'),
					A3(author$project$App$Model$Variant, 'royal blue', '$750', '11'),
					A3(author$project$App$Model$Variant, 'cinnamon red', '$750', '10'),
					A3(author$project$App$Model$Variant, 'race yellow', '$750', '14'),
					A3(author$project$App$Model$Variant, 'Race yellow & black limited edition', '$1250', '19')
				]),
			false),
			A6(
			author$project$App$Model$Dress,
			...
			elm_lang$core$Maybe$Just(
				_List_fromArray(
					['http://karleeneberle.com/images/portfolio/portfolio_gallery_1_2.jpg', 'http://karleeneberle.com/images/portfolio/portfolio_gallery_1_2.jpg'])),
			_List_fromArray(
				[
					A3(author$project$App$Model$Variant, 'french blue', '$750', '6'),
					A3(author$project$App$Model$Variant, 'french blue', '$750', '10'),
					A3(author$project$App$Model$Variant, 'french blue', '$750', '11'),
					A3(author$project$App$Model$Variant, 'bull red', '$750', '10'),
					A3(author$project$App$Model$Variant, 'canary yellow', '$750', '14')
				]),
			false)
		]));
...
var author$project$App$Init$init = function (flags) {
	return _Utils_Tuple2(author$project$App$Init$initial_state, elm_lang$core$Platform$Cmd$none);
};
...
var author$project$App$Subscription$subscriptions = function (model) {
	return elm_lang$core$Platform$Sub$none;
};
var author$project$App$Update$setVisibility = F2(
	function (dress, bool) {
...
var author$project$App$Update$updateDressInventory = F2(
	function (updatedDress, inventory) {
		var select = function (existingDress) {
			return _Utils_eq(existingDress.id, updatedDress.id) ? updatedDress : existingDress;
		};
		return _Utils_update(
			inventory,
			{
				dresses: A2(elm_lang$core$List$map, select, inventory.dresses),
				version: inventory.version + 1
			});
	});
var author$project$App$Update$update = F2(
	function (message, inventory) {
		if (message.$ === 'Expand') {
			var dress = message.a;
			return _Utils_Tuple2(
				A2(
					author$project$App$Update$updateDressInventory,
					A2(author$project$App$Update$setVisibility, dress, true),
					inventory),
			...
			return _Utils_Tuple2(
				A2(
					author$project$App$Update$updateDressInventory,
					A2(author$project$App$Update$setVisibility, dress, false),
					inventory),
				elm_lang$core$Platform$Cmd$none);
		}
	});
var author$project$App$Msg$Collapse = function (a) {
	return {$: 'Collapse', a: a};
};
var author$project$App$Msg$Expand = function (a) {
	return {$: 'Expand', a: a};
};
...
var author$project$App$View$dress_action = function (model) {
	return model.visible ? A2(
		elm_lang$html$Html$button,
		_List_fromArray(
			[
				elm_lang$html$Html$Events$onClick(
				author$project$App$Msg$Collapse(model))
			]),
		_List_fromArray(
			[
				elm_lang$html$Html$text(
				'Hide' + elm_lang$core$String$fromInt(model.id))
			])) : A2(
		elm_lang$html$Html$button,
		_List_fromArray(
			[
				elm_lang$html$Html$Events$onClick(
				author$project$App$Msg$Expand(model))
			]),
		_List_fromArray(
			[
				elm_lang$html$Html$text(
				'Show' + elm_lang$core$String$fromInt(model.id))
			]));
};
var elm_lang$html$Html$h3 = _VirtualDom_node('h3');
...
var author$project$App$View$name = function (value) {
	return A2(
		elm_lang$html$Html$h3,
		_List_fromArray(
			[
				elm_lang$html$Html$Attributes$class('name')
			]),
		_List_fromArray(
			[
				elm_lang$html$Html$text(value)
			]));
};
var elm_lang$html$Html$dd = _VirtualDom_node('dd');
var elm_lang$html$Html$dl = _VirtualDom_node('dl');
var elm_lang$html$Html$dt = _VirtualDom_node('dt');
var author$project$App$View$label_value = F3(
	function (kind, label, value) {
		return A2(
			elm_lang$html$Html$dl,
			_List_fromArray(
				[
					elm_lang$html$Html$Attributes$class(kind)
				]),
			_List_fromArray(
				[
					A2(
					elm_lang$html$Html$dt,
					_List_fromArray(
						[
							elm_lang$html$Html$Attributes$class('label')
						]),
					_List_fromArray(
						[
							elm_lang$html$Html$text(label)
						])),
					A2(
					elm_lang$html$Html$dd,
					_List_fromArray(
						[
							elm_lang$html$Html$Attributes$class('value')
						]),
					_List_fromArray(
						[
							elm_lang$html$Html$text(value)
...
var author$project$App$View$color = function (input) {
	return A3(author$project$App$View$label_value, 'color', 'Color', input);
};
var author$project$App$View$price = A2(author$project$App$View$label_value, 'price', 'Price');
var author$project$App$View$size = A2(author$project$App$View$label_value, 'size', 'Size');
var elm_lang$html$Html$li = _VirtualDom_node('li');
var author$project$App$View$variant = function (model) {
	return A2(
		elm_lang$html$Html$li,
		_List_fromArray(
			[
				elm_lang$html$Html$Attributes$class('variant')
			]),
		_List_fromArray(
			[
				author$project$App$View$color(model.color),
				author$project$App$View$price(model.price),
				author$project$App$View$size(model.size)
			]));
};
var elm_lang$html$Html$ul = _VirtualDom_node('ul');
var author$project$App$View$variants = function (list) {
	return A2(
		elm_lang$html$Html$ul,
		_List_fromArray(
			[
				elm_lang$html$Html$Attributes$class('variants')
			]),
		A2(
			elm_lang$core$List$map,
			function (v) {
				return author$project$App$View$variant(v);
			},
			list));
};
var author$project$App$View$dress = function (model) {
	return model.visible ? A2(
		elm_lang$html$Html$li,
		_List_fromArray(
			[
				elm_lang$html$Html$Attributes$class('dress')
			]),
		_List_fromArray(
			[
				author$project$App$View$dress_action(model),
				author$project$App$View$name(model.name),
				author$project$App$View$variants(model.variants)
			])) : A2(
		elm_lang$html$Html$li,
		_List_fromArray(
			[
				elm_lang$html$Html$Attributes$class('dress hidden')
			]),
		_List_fromArray(
			[
				author$project$App$View$dress_action(model)
...
var author$project$App$View$dresses = function (list) {
	return A2(
		elm_lang$core$List$map,
		function (d) {
			return author$project$App$View$dress(d);
		},
		list);
};
var elm_lang$html$Html$div = _VirtualDom_node('div');
var author$project$App$View$view = function (inventory) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm_lang$html$Html$Attributes$class('inventory')
					]),
				_List_fromArray(
					[
						elm_lang$html$Html$text(
						'Inventory  (Version' + (elm_lang$core$String$fromInt(inventory.version) + ')'))
					])),
				A2(
				elm_lang$html$Html$ul,
				_List_fromArray(
					[
						elm_lang$html$Html$Attributes$class('dresses')
					]),
				author$project$App$View$dresses(inventory.dresses))
			]));
};
...
var author$project$Main$main = elm_lang$browser$Browser$embed(
	{init: author$project$App$Init$init, subscriptions: author$project$App$Subscription$subscriptions, update: author$project$App$Update$update, view: author$project$App$View$view});
